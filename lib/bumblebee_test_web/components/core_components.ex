defmodule BumblebeeTestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BumblebeeTestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BumblebeeTestWeb.Gettext, "errors", msg, opts)
    end
  end
